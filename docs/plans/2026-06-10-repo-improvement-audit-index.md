...
| proposed | [terminal-restore-and-startup-performance](2026-06-10-terminal-restore-and-startup-performance.md) | Restore is N × serial surface creation gated on retried `zmx list`; Worktrunk modal can block launch; 2s health timer over all surfaces; Derived recomputes per access | baseline/after timing table; discovery-deferral + health-gating tests |
