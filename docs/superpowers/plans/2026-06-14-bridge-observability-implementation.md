...
- The removed monolithic Bridge architecture document was 2914 lines. This historical plan was grounded in its then-current state table, three-stream architecture, MainActor boundary, content lifecycle, SLO budget, LUNA-337 checkpoint, transport phases, invariants, and folder map sections. Current ownership now lives in [Bridge Viewer Architecture](../../architecture/bridge_viewer_architecture.md), [Bridge Native Runtime Architecture](../../architecture/bridge_native_runtime_architecture.md), and [Bridge Web Runtime Architecture](../../architecture/bridge_web_runtime_architecture.md).
