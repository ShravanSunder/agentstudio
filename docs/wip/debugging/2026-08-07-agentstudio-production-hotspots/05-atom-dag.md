...
The view already uses keyed repo enrichment reads at [RepoExplorerView.swift:124](../../../../Sources/AgentStudio/Features/RepoExplorer/RepoExplorerView.swift:124). It does not remain fully keyed for worktree facts: [RepoExplorerView.swift:155](../../../../Sources/AgentStudio/Features/RepoExplorer/RepoExplorerView.swift:155) calls `repoCache.worktreeFactsSnapshot()`, which snapshots both worktree enrichment and PR-count maps before filtering to visible worktrees. The cache implementation is [RepoCacheAtom.swift:98](../../../../Sources/AgentStudio/Core/State/MainActor/Atoms/RepoCacheAtom.swift:98).

The topology owner is also array-shaped: `RepositoryTopologyAtom.repos` is a single observable array at [RepositoryTopologyAtom.swift:7](../../../../Sources/AgentStudio/Core/State/MainActor/Atoms/RepositoryTopologyAtom.swift:7), and `RepoExplorerView.sidebarRepos` maps the whole array at [RepoExplorerView.swift:109](../../../../Sources/AgentStudio/Features/RepoExplorer/RepoExplorerView.swift:109).
...
These are source-backed complexity shapes, not measured production CPU shares yet. Anchors are [WorkspaceTabLayoutDerived.swift](../../../../Sources/AgentStudio/Core/State/MainActor/Atoms/WorkspaceTabLayoutDerived.swift:26), [WorkspaceTabArrangementAtom+Projection.swift](../../../../Sources/AgentStudio/Core/State/MainActor/Atoms/WorkspaceTabArrangementAtom+Projection.swift:115), and [CollapsedPaneBar.swift](../../../../Sources/AgentStudio/Core/Views/Panes/CollapsedPaneBar.swift:95).
