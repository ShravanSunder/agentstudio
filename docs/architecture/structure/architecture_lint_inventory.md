...
| Tests install the shared Core atom fallback only through [`TestAtomRegistry.swift`](../../../Tests/AgentStudioTests/TestSupport/TestAtomRegistry.swift). | `agentstudio_test_core_atom_fallback_ownership` | error | [`docs/architecture/structure/directory_structure.md`](directory_structure.md#test-target-ownership) |
