...
See [AgentStudio App IPC Architecture](../commands/ipc.md) for the
...
| [Session Lifecycle](../runtime/session_lifecycle.md) | Session creation, close, undo, restore |
| [Surface Architecture](../runtime/ghostty_surface_architecture.md) | Ghostty surface ownership and lifecycle |
| [App Architecture](../hosting/appkit_swiftui_architecture.md) | AppKit+SwiftUI hybrid, controllers |
