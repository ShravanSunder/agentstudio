...
| [Pane Runtime Option 2 Design](pane_runtime_option2_design.md) | Proposed background-ingestion + MainActor-coordination split for pane/system/plugin events; facets propagation and tradeoffs vs Options 1/3 |
