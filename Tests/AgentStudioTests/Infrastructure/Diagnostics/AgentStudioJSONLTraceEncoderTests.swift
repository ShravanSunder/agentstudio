    ...
    func encodeLineWritesOneJsonObjectPlusNewline() throws {
        let record = AgentStudioTraceRecord(
            ...
            attributes: [
                ...
                "agentstudio.runtime.session_id": .string("runtime-123"),
                "agentstudio.runtime.update_count": .int(7),
                "agentstudio.runtime.accepted": .bool(true),
                "agentstudio.runtime.types": .stringArray(["progress", "bell"]),
            ]
        )
        ...
        #expect(object["body"] as? String == "runtime.update")
        ...
        #expect(scope["name"] == "agentstudio.runtime")
        #expect(scope["version"] == "0.1.0")

        let attributes = try #require(object["attributes"] as? [String: Any])
        #expect(attributes["agentstudio.trace.tag"] as? String == "runtime")
        #expect(attributes["agentstudio.runtime.session_id"] as? String == "runtime-123")
        #expect(attributes["agentstudio.runtime.update_count"] as? NSNumber == 7)
        #expect(attributes["agentstudio.runtime.accepted"] as? Bool == true)
        #expect(attributes["agentstudio.runtime.types"] as? [String] == ["progress", "bell"])
    }
