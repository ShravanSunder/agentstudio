...
struct WorktreeAnnotationTransportAdapterTests {
    ...
    func committedRootCommandReturnsOutcomeAndPersistsDetail() async throws {
        ...
        // Act
        let observer = await harness.store.registerChangeObserver(scope: .testScope(transportAdapterAnnotationSubject))
        ...
        #expect(change.scopeKey == WorktreeAnnotationScope.testScope(transportAdapterAnnotationSubject).key)
