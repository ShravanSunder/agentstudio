...
struct RepositoryFactDemandArchitectureTests {
    ...
    func demandCaptureUsesOnlyNarrowCanonicalFacts() throws {
        ...
        #expect(coordinatorSource.contains("repositoryStableKey(for:"))
        #expect(coordinatorSource.contains("worktreeStableKey(for:"))
        #expect(!coordinatorSource.contains("repository.stableKey"))
        #expect(!coordinatorSource.contains("$0.stableKey"))
        #expect(!coordinatorSource.contains("StableKey.fromPath"))
