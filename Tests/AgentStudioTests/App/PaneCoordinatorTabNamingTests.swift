...
struct PaneCoordinatorTabNamingTests {
    ...
    private func makeHarness() -> (store: WorkspaceStore, coordinator: PaneCoordinator, tempDir: URL) {
        ...
        let coordinator = makeTestPaneCoordinator(
            ...
            surfaceManager: MockPaneCoordinatorTabNamingSurfaceManager(),
...
private final class MockPaneCoordinatorTabNamingSurfaceManager: PaneCoordinatorSurfaceManaging {
