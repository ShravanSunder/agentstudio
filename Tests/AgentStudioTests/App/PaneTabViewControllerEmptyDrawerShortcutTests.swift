...
extension PaneTabViewControllerDrawerCommandTests {
    ...
    func rawP_openEmptyDrawerWithEmptyDrawerFocus_createsFirstDrawerPane() throws {
        ...
        #expect(harness.controller.handleAppOwnedKeyEvent(event, allowsModifiedEmptyDrawerShortcutWithTextFocus: true))
    ...
    func performKeyEquivalent_cmdShiftDWithTextInputFocus_createsFirstDrawerPane() throws {
        let harness = makeHarness()
        defer { try? FileManager.default.removeItem(at: harness.tempDir) }
