...
struct ApplicationEntrypointArchitectureTests {
    ...
    func appIPCServerIsComposedAtAppBootAndStoppedOnTermination() throws {
        ...
        #expect(ipcBootSource.contains("recognizedCommands: AgentStudioIPCCommandCatalogProjection.recognizedCommands"))
        #expect(ipcBootSource.contains("ownPaneScopePort: WorkspaceOwnPaneScopePort("))
        #expect(ipcBootSource.contains("workspaceStore: store, performanceTraceRecorder: performanceTraceRecorder)"))
