...
final class AppCommandTests {
    ...
    func test_sidebarAndPaneInboxDefinitions_areCommandBarVisibleWithShortcuts() {
        ...
        #expect(clearInbox.commandBarGroupName == sidebarInbox.commandBarGroupName)
        #expect(clearInbox.commandBarGroupPriority == sidebarInbox.commandBarGroupPriority)
        #expect(clearInbox.icon == .system(.deleteLeft))
        ...
        #expect(clearPaneInbox.commandBarGroupName == paneInbox.commandBarGroupName)
