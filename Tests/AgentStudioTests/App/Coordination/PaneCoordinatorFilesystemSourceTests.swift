...
@MainActor
@Suite(.serialized)
struct PaneCoordinatorFilesystemSourceTests {
    init() {
    ...
    private func makeCoordinator(
        ...
        source: some PaneCoordinatorFilesystemSourceManaging,
        index: some PaneCoordinatorFilesystemProjectionIndexing,
...
private actor OrderedRecordingFilesystemSource: PaneCoordinatorFilesystemSourceManaging {
...
@MainActor
private final class MockFilesystemCoordinatorSurfaceManager: PaneCoordinatorSurfaceManaging {
