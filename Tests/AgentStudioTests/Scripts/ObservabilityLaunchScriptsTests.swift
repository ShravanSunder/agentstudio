...
struct ObservabilityLaunchScriptsTests {
    ...
    func miseSwiftTestTasksForwardRequestedFiltersThroughSlotWrapper() throws {
        ...
        #expect(testHelperScript.contains("Optional timeout for the first cold class shard"))
        ...
        #expect(testHelperScript.contains("SWIFT_TEST_FIRST_SHARD_TIMEOUT_SECONDS:-$TIMEOUT_SECONDS"))
        ...
        #expect(ciWorkflow.contains("SWIFT_TEST_FIRST_SHARD_TIMEOUT_SECONDS: \"1200\""))
