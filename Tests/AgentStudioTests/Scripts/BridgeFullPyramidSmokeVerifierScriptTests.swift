...
struct BridgeFullPyramidSmokeVerifierScriptTests {
    ...
    func reviewJourneyVerifierIsWiredThroughMiseAndAssertsSelectionTelemetryBudgets() throws {
        ...
        #expect(script.contains("code_view_item_materialize selected items materialize exactly once per selection"))
        ...
        #expect(script.contains("selected_content_painted materialize_ms present exactly once per selection"))
