...
describe("chapter surfaces on the home page", () => {
  ...
  it("lays the steps out as a horizontal dot row on phones with only the current step's copy", async () => {
    // Act
    ...
    // Assert: a horizontal tablist of dots on one line, each a real target.
