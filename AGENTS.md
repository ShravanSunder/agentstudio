...
**Coordination plane.** Use the narrowest plane that still preserves the
boundary:
...
OTLP scrub live in
[Observability — Local proof launch](docs/architecture/observability_and_traceability.md#local-proof-launch).
