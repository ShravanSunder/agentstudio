...
| `RepositoryTopologyAtom` | repos, worktrees, watched paths, availability | `Core/State/MainActor/Atoms/RepositoryTopologyAtom.swift` |
...
| `RepositoryTopologyStore` | persistence wrapper for `RepositoryTopologyAtom`; owns topology restore, observation, dirty tracking, and canonical flush participation | `Core/State/MainActor/Persistence/RepositoryTopologyStore.swift` |
| `WorkspaceStore` | persistence wrapper over workspace identity, window memory, pane graph, drawer cursor, tab graph/cursors, and pane presentation; coordinates canonical workspace flush with repository topology as a peer participant | `Core/State/MainActor/Persistence/WorkspaceStore.swift` |
...
| `RepositoryTopologyAtom` | `Core/State/MainActor/Atoms/` | Repos, worktrees, watched paths, availability |
