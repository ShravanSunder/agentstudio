    ...
    var definition: CommandSpec {
        ...
        case .managementLayerFocusLeft:
            return managementLayerDefinition(
                ...
                label: "Management Layer Focus Left",
                icon: "arrow.left",
        ...
        case .managementLayerFocusRight:
            return managementLayerDefinition(
                ...
                label: "Management Layer Focus Right",
                icon: "arrow.right",
        ...
        case .managementLayerEnterDrawer:
            return managementLayerDefinition(
                ...
                label: "Management Layer Enter Drawer",
                icon: "arrow.down",
        ...
        case .managementLayerExitDrawer:
            return managementLayerDefinition(
                ...
                label: "Management Layer Exit Drawer",
                icon: "arrow.up",
        ...
        case .managementLayerOpenDrawer:
            return managementLayerDefinition(
                ...
                label: "Management Layer Open Drawer",
                icon: "rectangle.expand.vertical",
                helpText: "Open the current drawer in the management layer"
            )
        case .managementLayerCreateTerminal:
            return managementLayerDefinition(
                shortcut: .managementLayerCreateTerminal,
                label: "Management Layer Create Terminal",
                icon: "plus.square",
                helpText: "Create a terminal in the current management-layer context"
            )
        case .managementLayerCreateBrowser:
            return managementLayerDefinition(
                shortcut: .managementLayerCreateBrowser,
                label: "Management Layer Create Browser",
                icon: "globe",
