enum AgentStudioCoordinationProjectionKeys {
    static let numericKeys: Set<String> = [
        ...
        "agentstudio.performance.coordinator.skipped_unchanged_input.count",
