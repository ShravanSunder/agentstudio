...
package enum AgentStudioOTLPTraceProjection {
    ...
    private static let allowedStringAttributeKeys: Set<String> = Set([
        ...
        "agentstudio.bridge.native_capacity.activity_rank",
        "agentstudio.bridge.native_capacity.event",
    ...
    private static let allowedNumericAttributeKeys: Set<String> = Set([
        ...
        "agentstudio.performance.pane.association_boot.pane.count",
        "agentstudio.performance.pane.association_boot.retained_known.count",
        "agentstudio.performance.pane.association_boot.backfilled.count",
        "agentstudio.performance.pane.association_boot.dangling_cleared.count",
        "agentstudio.performance.pane.association_boot.free_nil.count",
        "agentstudio.performance.pane.association_boot.changed.count",
        ...
        "agentstudio.startup_diagnostic.bridge.file_view.native_probe.failure_drop.count",
        "agentstudio.startup_diagnostic.bridge.file_view.native_probe.frame_evidence.count",
        "agentstudio.startup_diagnostic.bridge.file_view.native_probe.final_generation",
        ...
        "agentstudio.startup_diagnostic.bridge.file_view.native_probe.last_receiver_generation",
        ...
        "agentstudio.startup_diagnostic.bridge.painted_probe.already_painted_by_hydration.count",
        "agentstudio.startup_diagnostic.bridge.painted_probe.anchored_delivery_anchor_present.count",
        "agentstudio.startup_diagnostic.bridge.painted_probe.anchored_delivery_entry.count",
        "agentstudio.startup_diagnostic.bridge.painted_probe.anchored_delivery_recorder_present.count",
        "agentstudio.startup_diagnostic.bridge.painted_probe.anchored_delivery_selected_match.count",
        "agentstudio.startup_diagnostic.bridge.painted_probe.early_return.count",
        "agentstudio.startup_diagnostic.bridge.painted_probe.flush_called.count",
        "agentstudio.startup_diagnostic.bridge.painted_probe.generation_superseded.count",
        "agentstudio.startup_diagnostic.bridge.painted_probe.raf_fired.count",
        "agentstudio.startup_diagnostic.bridge.painted_probe.raf_scheduled.count",
        "agentstudio.startup_diagnostic.bridge.painted_probe.sample_recorded.count",
        "agentstudio.startup_diagnostic.bridge.painted_probe.schedule_entered.count",
