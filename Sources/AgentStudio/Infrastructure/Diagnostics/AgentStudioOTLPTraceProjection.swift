...
enum AgentStudioOTLPTraceProjection {
    ...
    private static let allowedNumericAttributeKeys: Set<String> = [
        ...
        "agentstudio.performance.bridge.active_refresh.count",
        "agentstudio.performance.bridge.coalesced_demand.count",
        "agentstudio.performance.bridge.final_commit.count",
        "agentstudio.performance.bridge.invalidation.count",
        "agentstudio.performance.bridge.stale_rejection.count",
