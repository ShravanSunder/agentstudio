...
function DropdownMenuPortal({ ...props }: MenuPrimitive.Portal.Props): ReactElement {
...
function DropdownMenuSubContent({
	...
	className,
	...props
}: React.ComponentProps<typeof DropdownMenuContent>): ReactElement {
	return (
		<DropdownMenuContent
...
function DropdownMenuSeparator({
	className,
	...props
}: MenuPrimitive.Separator.Props): ReactElement {
	return (
...
function DropdownMenuShortcut({ className, ...props }: React.ComponentProps<'span'>): ReactElement {
	return (
		<span
