...
function FieldSet({ className, ...props }: ComponentProps<'fieldset'>): ReactElement {
	return (
		<fieldset
			data-slot="field-set"
			className={cn(
...
function FieldLegend({
	...
	variant = 'legend',
	...props
}: ComponentProps<'legend'> & { variant?: 'legend' | 'label' }): ReactElement {
	return (
		<legend
...
function Field({
	...
	orientation = 'vertical',
	...props
}: ComponentProps<'div'> & VariantProps<typeof fieldVariants>): ReactElement {
	return (
		<div
			role="group"
			data-slot="field"
...
function FieldLabel({ className, ...props }: ComponentProps<typeof Label>): ReactElement {
	return (
		<Label
...
function FieldDescription({ className, ...props }: ComponentProps<'p'>): ReactElement {
	return (
		<p
