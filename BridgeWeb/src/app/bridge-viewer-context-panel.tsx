...
export function BridgeViewerContextPanel(props: BridgeViewerContextPanelProps): ReactElement {
	...
	return (
		<DrawerContent
			...
			className={`data-[swipe-axis=x]:top-2 data-[swipe-axis=x]:[--bleed:0px] data-[swipe-axis=x]:[--drawer-content-width:min(384px,calc(100%_-_32px))] data-[swipe-axis=x]:sm:[--drawer-content-width:min(384px,calc(100%_-_32px))] data-[swipe-direction=right]:right-2 ${
				props.height === 'full'
