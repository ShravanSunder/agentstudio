...
function convertedSurfaceSources(): readonly SourceEntry[] {
	return [
		...
		'../../file-viewer/use-bridge-file-viewer-content-controller.ts',
		'../../file-viewer/use-bridge-file-viewer-visible-demand-controller.ts',
		'../../file-viewer/use-bridge-file-viewer-descriptor-request-controller.ts',
		'../../file-viewer/use-bridge-file-viewer-frame-intake-controller.ts',
		'../../file-viewer/use-bridge-file-viewer-recently-updated-demand.ts',
